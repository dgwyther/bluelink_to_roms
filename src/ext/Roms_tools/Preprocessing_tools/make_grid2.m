...
%  cae west coast outer grid
%  (lat1,lon1) is the bottom left point
%  (lat2,lon2) is the top right point
%  (lat3,lon3) is sort of the bottom right point (but not really)
%  (lat3,lon3) vs (lat1,lon1) determines angle
%  (lat2,lon2) vs (lat1,lon1) determines length/width of grid
%  I find it easier to set theta than mess with lat3,lon3
  %lon1=-127;
  %lat1=24;
  %lon2=-123;
  %lat2=48;
...
%
%cae theta=atan((lat3-lat1)/(lon3-lon1))
theta
