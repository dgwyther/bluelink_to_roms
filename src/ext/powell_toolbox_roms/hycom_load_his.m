function bad_list = hycom_load_his( grid, hisfile, histime, epoch )
...
dims=[3 4 4 4 4];
hycom={'ssh' 'u' 'v' 'temperature' 'salinity'};
url='http://hycom.coaps.fsu.edu:8080/thredds/dodsC/glb_analysis?%s';
...
hycomfile=sprintf(url,'Latitude,Longitude,MT,Depth');
...
hycomtime=datenum(1900,12,31)+nc_varget(hycomfile,'MT');
