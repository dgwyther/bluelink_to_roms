function [Xgrid,Ygrid]=obs_ijpos(gname,obslon,obslat,Ccorrection);
...
Xgrid=griddata(rlon,rlat,Igrid,obslon,obslat);
Ygrid=griddata(rlon,rlat,Jgrid,obslon,obslat);
