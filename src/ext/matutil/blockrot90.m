...
%
%   BLOCKROT90(A,P,Q) is the 90 degree counterclockwise rotation of all
%   P-by-Q submatrices of the matrix A.
%
%   BLOCKROT90(A,P,Q,K) is the K*90 degree rotation of all P-by-Q
%   submatrices of A, K = +-1,+-2,...
%
%   BLOCKROT90 is vectorized along higher dimensions, so the same
%   operations is performed on all 2-D slices A(:,:,I,J,K,...).
%
%   See also ROT90.

%   Author:      Peter J. Acklam
%   Time-stamp:  2002-03-03 13:51:34 +0100
