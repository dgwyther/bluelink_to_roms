...
%   perform the rotation counterclockwise around an axis perpendicular to a
%   plane through the specified dimensions.  When DIM is omitted, the
%   dimension vector [1 2] is used, which gives the same behaviour as ROT90.
%
...
%   Time-stamp:  2001-05-12 14:44:06 +0200
   ...
   if (n == 0) | ((sdim1 <= 1) & (sdim2 <= 1))
      ...
      switch n
         case 1                 % 90 degrees counterclockwise
            ...
            B = permute(A(v{:}), d);
         case 2                 % 180 degrees counterclockwise
            v{dim1} = sdim1 : -1 : 1;
            v{dim2} = sdim2 : -1 : 1;
            B = A(v{:});
